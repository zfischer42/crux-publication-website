...
{#if data}
	...
	<div class="mx-auto px-3 w-full md:w-3/4 lg:w-3/5 md:mt-3 z-20 mb-2">
		<div class="flex flex-col h-full">
			<!-- Header -->
			<div class="flex-none w-full bg-gradient-to-r from-[#315AB0] to-[#07d1f9c1] p-3 rounded-t-lg md:bg-transparent md:p-0 md:rounded-none md:mb-3">
				<h2 class="text-3xl font-bold text-zinc-100 md:text-zinc-900">Journals</h2>
			</div>
			...
			>
				<div class="flex flex-row justify-center overflow-x-auto p-4 items-start">
